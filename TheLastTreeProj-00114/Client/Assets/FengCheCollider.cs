...
public class FengCheCollider : MonoBehaviour {
    ...
    void OnCollisionEnter2D(Collision2D collision)
    {
        if (collision.transform.tag == "enemy")
        {
            ...
            collision.gameObject.transform.GetComponent<Rigidbody2D>().AddForce(new Vector2(direct.x * GameData.Instance.protectPower /6, direct.y * GameData.Instance.protectPower / 6));
